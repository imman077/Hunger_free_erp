...
def seed_rewards():
    ...
    tiers = [
        ...
        {'role': 'NGO', 'name': 'Beginner', 'min_points': 0, 'icon': '🌱'},
        {'role': 'NGO', 'name': 'Partner', 'min_points': 1001, 'icon': '🤝'},
        {'role': 'NGO', 'name': 'Elite', 'min_points': 5001, 'icon': '⚡'},
        {'role': 'NGO', 'name': 'Master', 'min_points': 15001, 'icon': '🏆'},
        {'role': 'NGO', 'name': 'Legend', 'min_points': 35001, 'icon': '👑'},
        {'role': 'NGO', 'name': 'Titan', 'min_points': 75001, 'icon': '💎'},
